    ...
    >
      ...
      <div class="h-16 flex items-center justify-between px-6 border-b border-gray-200">
        <div class="flex items-center space-x-3">
          ...
          <span class="text-xl font-bold text-gray-800">Жалбена</span>
        </div>
      ...
      <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        ...
        <router-link
          to="/"
          class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-slate-100 hover:text-slate-700 transition-colors duration-200"
          :class="{ 'bg-sky-50 text-sky-900': $route.path === '/' }"
        >
          <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
          </svg>
          <span class="font-medium">Почетна</span>
        </router-link>
        ...
        <router-link
          to="/podnosioci-zalbe"
          class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-slate-100 hover:text-slate-700 transition-colors duration-200"
          :class="{ 'bg-sky-50 text-sky-900': $route.path === '/podnosioci-zalbe' }"
        >
          <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
          </svg>
          <span class="font-medium">Подносиоци жалбе</span>
        </router-link>
        ...
        <router-link
          to="/zalbe"
          class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-slate-100 hover:text-slate-700 transition-colors duration-200"
          :class="{ 'bg-sky-50 text-sky-900': $route.path === '/zalbe' }"
        >
          <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
          </svg>
        ...
        <div>
          <button
            ...
            :class="{ 'bg-sky-50 text-sky-900': izvestajOpen || $route.path.startsWith('/izvestaji') }"
          >
            <div class="flex items-center">
              <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
              <span class="font-medium">Извештаји</span>
            </div>
            <svg
          ...
          >
            <div v-show="izvestajOpen" class="ml-4 mt-2 space-y-1 border-l-2 border-slate-200 pl-4">
              <router-link
                ...
                :class="{ 'bg-sky-50 text-sky-900': $route.path === '/izvestaji/neresene-zalbe' }"
              >
              ...
              <router-link
                ...
                class="block px-4 py-2 text-sm text-gray-600 rounded-lg hover:bg-slate-100 hover:text-slate-700 transition-colors duration-200"
                :class="{ 'bg-sky-50 text-sky-900': $route.path === '/izvestaji/po-datumu-prijema' }"
              >
              ...
              <router-link
                ...
                class="block px-4 py-2 text-sm text-gray-600 rounded-lg hover:bg-slate-100 hover:text-slate-700 transition-colors duration-200"
                :class="{ 'bg-sky-50 text-sky-900': $route.path === '/izvestaji/tuzbe-od-us' }"
              >
              ...
              <router-link
                ...
                class="block px-4 py-2 text-sm text-gray-600 rounded-lg hover:bg-slate-100 hover:text-slate-700 transition-colors duration-200"
                :class="{ 'bg-sky-50 text-sky-900': $route.path === '/izvestaji/datum-ekspedicije' }"
              >
              ...
              <router-link
                ...
                class="block px-4 py-2 text-sm text-gray-600 rounded-lg hover:bg-slate-100 hover:text-slate-700 transition-colors duration-200"
                :class="{ 'bg-sky-50 text-sky-900': $route.path === '/izvestaji/ekspedovane-tuzbe' }"
              >
                Експедоване тужбе
              </router-link>
              <router-link
                ...
                class="block px-4 py-2 text-sm text-gray-600 rounded-lg hover:bg-slate-100 hover:text-slate-700 transition-colors duration-200"
                :class="{ 'bg-sky-50 text-sky-900': $route.path === '/izvestaji/odluke-suda' }"
              >
                Одлуке суда
              </router-link>
              <router-link
                ...
                class="block px-4 py-2 text-sm text-gray-600 rounded-lg hover:bg-slate-100 hover:text-slate-700 transition-colors duration-200"
                :class="{ 'bg-sky-50 text-sky-900': $route.path === '/izvestaji/upravni-sporovi-u-toku' }"
              >
      ...
      <header class="h-16 bg-white shadow-sm flex items-center justify-between px-6">
        ...
        <div class="flex items-center space-x-3">
          ...
          <div class="flex items-center space-x-2">
            <div class="w-9 h-9 bg-blue-700 rounded-full flex items-center justify-center text-white font-bold text-sm">
              {{ userInitials }}
            </div>
            <div>
