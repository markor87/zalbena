  ...
  <div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
      <div class="flex items-center justify-between">
        <h2 class="text-2xl font-bold text-gray-800">Управни спорови у току по годинама</h2>
        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr
              ...
              :key="index"
              :class="{ 'bg-gray-100 font-bold': item.godina === 'Укупно' }"
            >
...
const fetchData = async () => {
  try {
    ...
    const response = await axios.get('/izvestaj-upravni-sporovi-po-godinama');
