...
const exportExcel = () => {
  ...
  window.location.href = `/api/izvestaj-po-datumu-prijema/export-excel?${params.toString()}`;
...
const exportPdf = () => {
  ...
  window.location.href = `/api/izvestaj-po-datumu-prijema/export-pdf?${params.toString()}`;
