  ...
  <div class="min-h-screen bg-gradient-to-br from-slate-900 to-blue-900 flex items-center justify-center p-4">
    <div class="max-w-md w-full">
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-4xl font-bold text-white mb-2">Жалбена</h1>
        <p class="text-white/80">Систем за управљање жалбама</p>
      </div>

      <!-- Login Form -->
      <div class="bg-white rounded-3xl shadow-2xl p-8">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Пријавите се</h2>
        ...
        <form @submit.prevent="handleLogin" class="space-y-6">
          ...
          >
            <span v-if="!loading">Пријавите се</span>
...
const handleLogin = async () => {
  ...
  try {
    ...
    error.value = err.response?.data?.message || 'Грешка при пријављивању. Проверите своје податке.';
  } finally {
    loading.value = false;
  }
};
