...
<head>
    <meta charset="utf-8">
    <title>Извештај: Експедоване тужбе</title>
    <style>
        body {
...
<body>
    <h1>Извештај: Експедоване тужбе</h1>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>Институција</th>
                <th>Пријемни број</th>
                <th>Датум пријема одлуке УС</th>
                <th>Датум пријема жалбе</th>
                <th>Датум пријема тужбе од УС</th>
                <th>Датум експедиције одговора ЖК</th>
                <th>Статус</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->datum_prijema_odluke_us ? date('d.m.Y', strtotime($item->datum_prijema_odluke_us)) : '-' }}</td>
                ...
                <td>{{ $item->datum_ekspedicije_odgovora_zk ? date('d.m.Y', strtotime($item->datum_ekspedicije_odgovora_zk)) : '-' }}</td>
